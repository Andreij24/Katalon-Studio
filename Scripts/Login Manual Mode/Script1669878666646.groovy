...
WebUI.setText(findTestObject('Page_katalon-demo-cura - Website/Page_Login - KatalonWebsite/input_Username'), 'John Doe')

WebUI.setText(findTestObject('Page_katalon-demo-cura - Website/Page_Login - KatalonWebsite/input_Password'), 'ThisIsNotAPassword')

WebUI.click(findTestObject('Page_katalon-demo-cura - Website/Page_Login - KatalonWebsite/button_Login'))

WebUI.selectOptionByValue(findTestObject('Page_katalon-demo-cura - Website/Page_Appointment - KatalonWebsite/Appointment_Facility setup/select_Facility'), 
...
WebUI.click(findTestObject('Page_katalon-demo-cura - Website/Page_Appointment - KatalonWebsite/Appointment_Facility setup/checkbox_Hospital readmission'))
...
WebUI.click(findTestObject('Page_katalon-demo-cura - Website/Page_Appointment - KatalonWebsite/button_Confirm Appointment_GTHomepage'))
